...
pub const ENV_CELLS: [(&str, &'static OnceCell<String>); 14] = [
...
pub static DUMMY_EMAIL: OnceCell<String> = OnceCell::new();
...
pub static PRICE_CONNECTED: OnceCell<i64> = OnceCell::new();
...
pub static PRICE_PREMIUM: OnceCell<i64> = OnceCell::new();
